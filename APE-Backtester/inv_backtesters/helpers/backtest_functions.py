    ...
    #         return {}
        ...
        try:
            if strategy == "MA":
                ...
                sell_dict = trade.tda_CALL_3D_stdclsAGG(polygon_df,open_datetime,1,config,target_pct=.0265,vol=float(row["threeD_stddev50"]),standard_risk=.0175)
            elif strategy == "GAIN_1d":
                ...
                sell_dict = trade.tda_CALL_3D_stdclsAGG(polygon_df,open_datetime,1,config,target_pct=.0225,vol=float(row["threeD_stddev50"]),standard_risk=.015)
            elif strategy == "LOSERSC_1D":
                sell_dict = trade.tda_CALL_1D_stdclsAGG(polygon_df,open_datetime,1,config,target_pct=.014,vol=float(row["oneD_stddev50"]),standard_risk=.011)
            elif strategy == "GAINP":
                sell_dict = trade.tda_PUT_3D_stdclsAGG(polygon_df,open_datetime,1,config,target_pct=-.027,vol=float(row["threeD_stddev50"]),standard_risk=.015)
            elif strategy == "GAINP_1D":
