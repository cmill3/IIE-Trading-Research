...
def pull_data(s3link):
    ...
    end_date = backtrader_helper.create_end_date(start_time, 4)
...
def buy_iterate_sellV2(symbol, mkt_price, option_symbol, open_prices, strategy, polygon_df, commission_cost, quantity, position_id):
...
def simulate_trades(data, datetimelist, starting_value, commission_cost, s3link):
    ...
    for i, row in data.iterrows():
        ...
        for df in polygon_dfs:
            ...
            buy_dict, sell_dict, results_dict, transaction_dict, open_datetime = buy_iterate_sellV2(symbol, mkt_price, ticker, open_prices, strategy, df, commission_cost, 1, position_id)
