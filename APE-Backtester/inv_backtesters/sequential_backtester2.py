...
#         },
    ...
    for config in backtest_configs:
        trading_strat = f"{config['user']}-{nowstr}-modelVOLTRENDMA_dwnsdVOL:{config['model']}_{config['pos_limit']}_{config['dataset']}2_vol{config['volatility_threshold']}_sp{config['spread_length']}_sa{config['spread_adjustment']}"
