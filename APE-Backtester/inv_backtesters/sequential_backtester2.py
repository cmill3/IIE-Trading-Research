        ...
        },
{
    ...
    for config in backtest_configs:
        trading_strat = f"{config['user']}-{nowstr}-modelCDVOL-22_dwnsdVOL:{config['model']}_{config['dataset']}_vol{config['volatility_threshold']}_vc{config['vc_level']}_{config['scaling']}_sa{config['spread_adjustment']}"
