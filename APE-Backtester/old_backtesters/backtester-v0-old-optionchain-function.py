...
def polygon_ticker_call(x):
    ...
    historical_ticker_value.append(his_tic_val)
    historical_OOTM_strike_price_call_rounded = round_up_to_base((his_tic_val + (historical_ticker_value[i] * 0.025)))
    historical_OOTM_strike_price_put_rounded = round_down_to_base((his_tic_val - (historical_ticker_value[i] * 0.025)))
    historical_OOTM_strike_price_call.append(historical_OOTM_strike_price_call_rounded)
    historical_OOTM_strike_price_put.append(historical_OOTM_strike_price_put_rounded)
...
def options_chain_data_processing(x, i):
    ...
    if contract_type == "calls":
        strike_to_match = int(historical_OOTM_strike_price_call[i].values)
        strike_price = df_optionchain_2wk[(df_optionchain_2wk['strike'] == strike_to_match)].strike
        option_tick = df_optionchain_2wk[(df_optionchain_2wk['strike'] == strike_to_match)].contractSymbol
        ...
        strike_to_match = int(historical_OOTM_strike_price_put[i].values)
        strike_price = df_optionchain_2wk[(df_optionchain_2wk['strike'] == strike_to_match)].strike
        option_tick = df_optionchain_2wk[(df_optionchain_2wk['strike'] == strike_to_match)].contractSymbol
        option_tick_value = str(option_tick[0])
        if len(x) == 1:
...
print(type(backtester_start_datetime))
print(type(backtester_end_datetime[0]))
